  ...
  // WRITE AND TEST THE METHODS BELOW
    ...
    */
    public String halvesReversed(String myString) {
        ...
        String a = myString.substring(0, split);
        String b = myString.substring(split);
        return b + a;
    }
    ...
    */
    public String pigLatin(String orig) {
        String first = orig.substring(0, 1);
        return orig.substring(1) + first + "ay";
    }
    ...
    public String removeCharacter(String myString, int removeIdx) {
        if (removeIdx < 0 || removeIdx > myString.length() - 1) return myString;
    ...
    */
    public String insertAt(String orig, String insertText, String searchStr) {
        ...
        if (idx == -1) return orig + insertText;
        String a = orig.substring(0, idx);
        String b = orig.substring(idx);
        return a + insertText + b;
    }
    ...
    */
    public String endUp(String myString, int numToCap) {
        if (myString.length() < numToCap) return myString.toUpperCase();
        return myString.substring(0, myString.length() - numToCap) 
        + myString.substring(myString.length() - numToCap).toUpperCase();
    }
    ...
    */
    public String yellOrWhisper(String myString) {
        ...
        return (first == first.toLowerCase()) ? myString.toLowerCase() : myString.toUpperCase();
    }
    ...
    public String starBetween(String myString) {
        ...
        return str + myString.substring(myString.length() - 1);
    }
}
